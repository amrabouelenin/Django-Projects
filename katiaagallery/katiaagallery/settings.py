"""
Django settings for katiaagallery project.
...
SECRET_KEY = '&_0*1#eonubl@+3dh#u@p1v81wa&8lht)f)wjz_*o6_yc*vx&g'
...
ROOT_URLCONF = 'katiaagallery.urls'
...
WSGI_APPLICATION = 'katiaagallery.wsgi.application'
